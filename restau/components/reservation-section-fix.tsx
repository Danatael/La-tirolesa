...
import { Form, FormItem, FormLabel, FormControl, FormMessage, FormField } from "@/components/ui/form-fix"
...
export default function ReservationSection() {
    ...
    // Si el componente no está montado, mostramos un esqueleto o versión simplificada
    if (!isMounted) {
        return (
            <section id="reservation" className="py-16">
                <div className="container">
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="h-[400px] bg-muted/30 rounded-lg animate-pulse"></div>
                    </div>
                </div>
            </section>
        )
        ...
        <section id="reservation" className="py-16">
            <div className="container">
                <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        Completa el formulario a continuación para reservar una mesa o consultar sobre la organización de eventos
                        especiales.
                    </p>
                </div>
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input placeholder="tu@email.com" {...field} suppressHydrationWarning />
                                                            </FormControl>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
